      ...
      {showLogoutModal && (
        <div className="modal-overlay" onClick={() => setShowLogoutModal(false)}>
          <div className="modal-content logout-confirm animate-scale-up" onClick={e => e.stopPropagation()}>
            ...
            <p className="modal-p-logout">Are you sure you want to end your session?</p>
            <div className="modal-actions-logout">
              <button className="btn-cancel-logout" onClick={() => setShowLogoutModal(false)}>Cancel</button>
